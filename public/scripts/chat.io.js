(function($){
	...
	function bindSocketEvents(){
        ...
        socket.on('connect', function (){
         	// firing back the nick event to the server and sending the nickname for the connected client
			socket.emit('nick', { nickname: nickname });
		});
		...
		socket.on('roomclients', function(data){
			...
			insertMessage(serverDisplayName, welcomeMsg + ", o meu nome &eacute " + data.room + ' em que posso ajudar?', true, false, true);
